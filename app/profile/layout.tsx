...
export default function PageLayout({
    ...
    return (
        <main>
            ...
            <nav role="navigation" aria-label="Profile navigation" className='flex justify-around items-center border border-x-0 border-t-0 border-b-1 border-b-[#b6b6b6] dark:border-b-[#333333] h-10'>
