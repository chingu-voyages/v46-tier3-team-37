...
*/
-- CreateEnum
CREATE TYPE "Status" AS ENUM ('OPEN', 'ACTIVE', 'COMPLETED');
...
-- AddForeignKey
ALTER TABLE "Transaction" ADD CONSTRAINT "Transaction_renterId_fkey" FOREIGN KEY ("renterId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
